...
int main()
{
    ...
    Placer p = makePlacer("C:\\Users\\elsha\\Desktop\\IC\\SimulatedAnealling\\SimulatedAnealling\\d2.txt");
    ...
    while (window.isOpen())
    {
        ...
        if (temp > p.finalTemp) {
            ...
            textTemp.setPosition((p.ny/2.0f) * gridSize - 2*gridSize,  tempBarH/4);
